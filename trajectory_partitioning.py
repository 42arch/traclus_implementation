...
def call_partition_trajectory(trajectory_point_list):
    ...
    return partition_trajectory(trajectory_line_segs=trajectory_line_segs,
                                partition_cost_func=partition_cost,
                                no_partition_cost_func=no_partition_cost)


def partition_trajectory(trajectory_line_segs, partition_cost_func, no_partition_cost_func):
    """轨迹分段
...
def encoding_cost(trajectory_line_segs, low, high, partition_line, angular_dist_func, perpendicular_dist_func):
    """
